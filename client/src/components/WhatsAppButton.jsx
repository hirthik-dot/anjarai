...
const WhatsAppButton = () => {
  ...
  // Avoid blocking key actions on checkout / cart bottom-sheet.
  if (location.pathname === '/checkout' || isOpen) return null;
    ...
    return (
      ...
      className="fixed bottom-[80px] right-5 md:bottom-6 md:right-7 z-[2000] group"
        >
      <div className="relative w-[56px] h-[56px] rounded-full bg-[#25d366] shadow-[0_4px_20px_rgba(37,211,102,.5)] flex items-center justify-center transition-all duration-300 group-hover:scale-110 active:scale-90 group-hover:-translate-y-1">
